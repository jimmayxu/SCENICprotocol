...
if __name__ == '__main__':
    ...
    target_genes = pd.read_csv(args.targets_fpath)['TG'].tolist()
    ...
    with Pool(args.num_workers) as p:
        adjs = list(
            tqdm.tqdm(
                p.imap(run_infer_partial_network, target_gene_indices(gene_names=gene_names, target_genes=target_genes), chunksize=1),
